...
def generate_X_y_f_classification(
    ...
    dgp_name="rectangular",  # indicating which DGP to use
    bernoulli_p=0.8,  # for 2 dim case
    n_samples=2048,  # size of dateset (train + test)
    feature_dim=30,  # for additive models
    random_state=7,
):
